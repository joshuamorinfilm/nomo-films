...
(function(){
    ...
    for(var i=0; i<vimeo.length; i++){
        ...
        vi_image.src = 'img/' + data_id + data_thumb + '.jpg'; //https://i.vimeocdn.com/video/611384407.webp?mw=700&mh=392
        vi_image.alt = '';
        ...
        vimeo[i].querySelector('.vi-lazyload-playbtn').addEventListener('click',function(){
            var vi_container = this.parentElement,
                ...
                vi_iframe.src = 'https://player.vimeo.com/video/' + vi_container.dataset.id + '?title=0&byline=0&portrait=0';
